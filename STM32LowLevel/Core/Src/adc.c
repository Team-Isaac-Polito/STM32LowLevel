...
void MX_ADC1_Init(void)
{
  ...
  */
  ...
  LL_GPIO_Init(VBAT_SENSE_GPIO_Port, &GPIO_InitStruct);

  GPIO_InitStruct.Pin = EFUSE2_IMON_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_ANALOG;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  LL_GPIO_Init(EFUSE2_IMON_GPIO_Port, &GPIO_InitStruct);
...
void MX_ADC2_Init(void)
{
  ...
  PC4   ------> ADC2_IN5
  */
  GPIO_InitStruct.Pin = EFUSE1_IMON_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_ANALOG;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  LL_GPIO_Init(EFUSE1_IMON_GPIO_Port, &GPIO_InitStruct);
